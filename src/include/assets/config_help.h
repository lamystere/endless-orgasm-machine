...
#define initial_pleasure_HELP _HELPSTR("The minimum speed the motor will start at in automatic mode.")
#define max_pleasure_HELP _HELPSTR("Maximum speed for the motor in auto-ramp mode.")
