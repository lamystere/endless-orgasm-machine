...
#define INITIAL_PLEASURE_HELP _HELPSTR("The minimum speed the motor will start at in endless mode.")
#define MAX_PLEASURE_HELP _HELPSTR("Maximum speed for the motor in endless & orgasm mode.")
#define MOTOR_RAMP_TIME_S_HELP _HELPSTR("The time it takes for the motor to reach Motor Max Speed in endless mode.")
#define EDGE_DELAY_HELP _HELPSTR("Minimum time (s) after edge detection before resuming stimulation.")
#define MAX_ADDITIONAL_DELAY_HELP _HELPSTR("Maximum time (s) that can be added to the edge delay before resuming stimulation. A random number will be picked between 0 and this setting each cycle. 0 to disable.")
#define MINIMUM_ON_TIME_HELP _HELPSTR("Time (s) after stimulation starts before edge detection is resumed.")
